...
export default function ProfilePage() {
  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen mx-4 mt-10 ">
      <div className="h-140 sm:w-100 w-80 mx-4 border bg-white border-[#202b38] p-2 rounded-3xl hover:border-[#677483] transition-colors duration-800">
